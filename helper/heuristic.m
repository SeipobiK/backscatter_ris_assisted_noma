...
parfor mc = 1:MC_MAX
    try
        ...
        [obj_history_dris_local,alpha_n_dris,alpha_f_dris,w_kdris] = run_dris_system(para, H_local, g_local, f_local, g_1_all, g_2_all, g_b_all, f1_all, f2_all, G_all_matrix, outer_iter, max_iter, max_feasible);
        
        % NDRIS: Optimized J matrices  
        [obj_history_ndris_local,alpha_n_ndris,alpha_f_ndris,w_kndris] = run_ndris_system(para, H_local, g_local, f_local, g_1_all, g_2_all, g_b_all, f1_all, f2_all, G_all_matrix, outer_iter, max_iter, max_feasible);
        ...
        alpha_f_mc_dris(:,mc) = alpha_n_dris;
        alpha_n_mc_dris(:,mc) = alpha_f_dris;
...
filename_all = sprintf('full_workspace_dris_vs_ndris_M%d_N%d_%s.mat', para.MC_MAX, para.N, timestamp);
save(filename_all);
...
function [obj_history,alpha_n, alpha_f,w_k] = run_dris_system(para, H_local, g_local, f_local, g_1_all, g_2_all, g_b_all, f1_all, f2_all, G_all_matrix, outer_iter, max_iter, max_feasible)
...
function [obj_history,alpha_n, alpha_f,w_k] = run_ndris_system(para, H_local, g_local, f_local, g_1_all, g_2_all, g_b_all, f1_all, f2_all, G_all_matrix, outer_iter, max_iter, max_feasible)
